      ...
      <PageShell>
        ...
        <Section>
          <div className="max-w-3xl space-y-10 text-gray text-sm leading-relaxed">
            <p className="text-xs text-gray/60">Effective Date: 27.02.2026</p>
            ...
            <LS n="2" title="Definitions">
              ...
              <p>2.3 "Affiliate" means any entity that controls, is controlled by, or is under common control with a party. Control means holding, directly or indirectly, more than 50 percent of the voting rights or otherwise having the ability to direct management and policies.</p>
              <p>2.4 "Deliverables" means any hardware, parts, prototypes, assemblies, software, firmware, models, drawings, documentation, test plans, acceptance criteria, test reports, data, and other work results provided by Deepvac.</p>
              <p>2.5 "Services" means any testing services, engineering, design, development, consulting, integration, commissioning, training, maintenance, repair, and related activities performed by Deepvac.</p>
            ...
            <LS n="3" title="Scope and Applicability">
              ...
              <p>3.2 These Terms apply exclusively to entrepreneurs within the meaning of Section 14 German Civil Code, legal entities under public law, and special funds under public law. Contracts with consumers are excluded.</p>
              <p>3.3 The Customer's terms and conditions do not apply, even if Deepvac does not object, unless Deepvac expressly agrees to them in text form.</p>
            ...
            <LS n="5" title="Contract Documents and Order of Precedence">
              ...
              <p>5.2 Marketing statements, website content, brochures, and general technical descriptions are non binding unless explicitly agreed as guaranteed characteristics in text form.</p>
            </LS>
            ...
            <LS n="6" title="Scope of Performance">
              ...
              <p>6.3 Unless expressly agreed, Deepvac does not owe regulatory approvals, certification outcomes, conformity assessments, or fitness for any specific purpose beyond the agreed specification.</p>
              <p>6.4 Deepvac may implement reasonable minor changes in design, components, or process if they do not materially impair the contractual purpose and are objectively reasonable for the Customer.</p>
            </LS>
            ...
            <LS n="7" title="Change Requests">
              ...
              <p>7.2 Deepvac will provide a change proposal including impact on price, schedule, and technical feasibility. Changes become binding only upon acceptance by both parties in text form.</p>
              <p>7.3 If the Customer requests work before a change order is agreed, such work is performed on a time and materials basis and does not imply acceptance of a fixed price or deadline.</p>
            </LS>

            {/* 8 */}
            <LS n="8" title="Customer Cooperation Duties">
              <p>8.1 The Customer shall provide all information, decisions, access, samples, drawings, specifications, and materials required for performance in a timely manner and free of charge to Deepvac.</p>
              ...
              <p>8.3 The Customer warrants that its data, materials, and instructions do not infringe third party rights. The Customer shall indemnify Deepvac against third party claims arising from such infringement, except to the extent caused by Deepvac.</p>
            ...
            <LS n="9" title="Testing Services Specific Terms">
              <p>9.1 Testing shall be performed according to the agreed test plan. If no test plan is agreed, testing shall be performed according to Deepvac's standard procedures appropriate to the assignment.</p>
              ...
              <p>9.3 Test results are valid only for the tested configuration and boundary conditions documented in the test report. Any extrapolation is at the Customer's risk.</p>
              ...
              <p>9.5 Deepvac may suspend or refuse testing if the test item presents a safety risk, lacks required documentation, or violates applicable rules. The Customer bears resulting costs.</p>
              <p>9.6 After completion of testing or Services, Deepvac will make the test item available for collection or shipment as agreed. Unless otherwise agreed, return shipment is at the Customer's cost and risk.</p>
              <p>9.7 Deepvac will store test items free of charge for up to thirty calendar days after notifying the Customer of completion or readiness for return, whichever occurs first.</p>
              <p>9.8 After the free storage period, Deepvac may charge reasonable storage fees. If the Customer does not arrange collection or shipment within a reasonable additional period after a written reminder, Deepvac may, where legally permissible, dispose of the test item at the Customer's expense. Where practicable, Deepvac will inform the Customer in advance.</p>
              <p>9.9 The Customer remains responsible for ensuring that test items are free of hazardous substances unless explicitly declared and agreed in text form. If hazardous materials are involved, the Customer shall provide complete safety data sheets and handling instructions prior to delivery.</p>
            </LS>
            ...
            <LS n="11" title="Delivery, Deadlines, and Force Majeure">
              ...
              <p>11.2 Delivery and performance periods start only after order confirmation, receipt of any agreed advance payment, and receipt of all Customer cooperation items required to start performance.</p>
              <p>11.3 Force majeure includes events beyond Deepvac's reasonable control, including supply chain disruptions, transportation disruptions, governmental measures, export restrictions, sanctions, labor disputes, power failures, cyber incidents not caused by Deepvac, pandemics, and natural events. In such cases, obligations are suspended for the duration, and deadlines extend accordingly.</p>
            ...
            <LS n="13" title="Acceptance of Deliverables">
              ...
              <p>13.2 If no acceptance procedure is agreed, acceptance occurs when Deepvac has notified the Customer in text form that the Deliverables are ready for acceptance and, in that notice, has informed the Customer of the acceptance mechanism under this clause 13.2, and then:</p>
              <ol className="list-[lower-alpha] pl-5 space-y-1">
            ...
            <LS n="14" title="Retention of Title">
              ...
              <p>14.3 The Customer may resell goods in the ordinary course of business. The Customer assigns to Deepvac, as security, all claims arising from such resale up to the amount of Deepvac's outstanding claims. Deepvac accepts this assignment.</p>
            </LS>

            {/* 15 */}
            <LS n="15" title="Warranty and Defect Claims">
              <p>15.1 The Customer shall inspect Deliverables without undue delay and notify defects in text form. Apparent defects must be notified within fourteen calendar days after delivery or completion. Hidden defects must be notified without undue delay and in any case within fourteen calendar days after discovery.</p>
              ...
              <p>15.3 The limitation period for defect claims is twelve months from delivery or completion, unless mandatory law requires longer periods.</p>
              ...
              <p>15.5 If the Customer or third parties perform remedial actions without Deepvac's prior consent, defect claims are excluded unless the Customer proves that such actions did not cause or aggravate the defect.</p>
            </LS>
            ...
            <LS n="16" title="Liability">
              ...
              <p>16.2 In case of slight negligence, Deepvac is liable only for breach of essential contractual obligations. Essential contractual obligations are obligations whose fulfilment is necessary to achieve the purpose of the Contract and on whose compliance the Customer may regularly rely.</p>
            ...
            <LS n="17" title="Intellectual Property and Rights of Use">
              ...
              <p>17.2 Unless expressly agreed otherwise, Deliverables created under the Contract grant the Customer a non exclusive, non transferable, non sublicensable right to use the Deliverables solely for the Customer's internal purposes and only to the extent necessary for the contractual purpose.</p>
            ...
            <LS n="22" title="Suspension, Termination, and Cancellation">
              ...
              <ol className="list-[lower-alpha] pl-5 space-y-1">
                ...
                <li>a reasonable cancellation fee reflecting the lost contribution margin, unless the Customer proves that Deepvac suffered no or lower loss.</li>
              </ol>
            ...
            <LS n="24" title="Governing Law, Jurisdiction, and Place of Performance">
              ...
              <p>24.2 Exclusive place of jurisdiction for all disputes arising out of or in connection with the Contract is Hanover, Germany.</p>
