      ...
      <PageShell>
        ...
        <Section>
          <SectionHeader
            ...
            title="Support Areas & Deliverables"
            className="mb-10"
          />
...
export const TestingServices = () => (
  <ServicePageTemplate
    ...
    scenarios={[
      "Satellite subsystem qualification campaigns",
      "Component-level environmental screening",
      "Research and development test programs",
      "Thermal cycling under high-vacuum conditions",
      "Outgassing and contamination characterisation",
...
export const ControlSystemsDesign = () => (
  <ServicePageTemplate
    ...
    scenarios={[
      "New chamber builds requiring integrated control systems",
      "Legacy systems needing control modernisation",
      "Facilities expanding data acquisition capabilities",
      "Projects with specific automation requirements",
      "Multi-chamber control integration",
      "Remote monitoring and diagnostics needs",
    ]}
    crossLinks={[
...
export const MechanicalDesign = () => (
  <ServicePageTemplate
    ...
    scenarios={[
      "Custom chamber development projects",
      "Fixture design for specific test articles",
      "Chamber modifications and extensions",
      "Feedthrough and port engineering",
      "Structural assessment of existing chambers",
      "Thermal shroud mechanical design",
    ]}
    crossLinks={[
...
export const RetrofitModernisation = () => (
  <ServicePageTemplate
    ...
    scenarios={[
      "Chambers with obsolete control systems",
      "Facilities requiring safety upgrades",
      "Systems with degraded performance or reliability",
      "Organisations expanding test capabilities on existing platforms",
      "Legacy systems needing modern data acquisition",
      "Equipment approaching end-of-life requiring lifecycle extension",
    ]}
    crossLinks={[
...
export const MaintenanceRepair = () => (
  <ServicePageTemplate
    ...
    scenarios={[
      ...
      "Unplanned chamber system failures",
      "Vacuum integrity degradation",
      "Sensor or instrumentation malfunction",
      "Pump system servicing requirements",
      "Seal replacement and leak repair",
    ]}
    crossLinks={[
...
export const SubsystemIntegration = () => (
  <ServicePageTemplate
    ...
    scenarios={[
      "New chamber builds with multi-vendor subsystems",
      "Facility upgrades requiring subsystem coordination",
      "Addition of new subsystems to existing chambers",
      "Complex feedthrough and instrumentation integration",
      "Thermal subsystem integration with vacuum systems",
      "Control system integration across multiple subsystems",
    ]}
    crossLinks={[
