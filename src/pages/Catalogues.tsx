...
const documents = [
  {
    title: "DEEPVAC Company Overview",
    description: "General introduction to DEEPVAC capabilities, product platforms, and engineering services.",
    tags: ["Overview"],
    featured: true,
  },
  {
    title: "T Series TVAC — Product Brochure",
    description: "Technical overview of the T Series cubic thermal vacuum chamber platform.",
    tags: ["TVAC"],
  },
  {
    title: "C Series TVAC — Product Brochure",
    description: "Technical overview of the C Series cylindrical thermal vacuum chamber platform.",
    tags: ["TVAC"],
  },
  {
    title: "Custom TVAC Systems",
    description: "Overview of DEEPVAC's custom thermal vacuum chamber engineering capabilities.",
    tags: ["TVAC", "Custom"],
  },
  {
  ...
  },
  {
    ...
    description: "Reference document for chamber specification discussions and project scoping.",
    tags: ["TVAC", "Custom"],
  },
];
...
const Catalogues = () => {
  ...
  const filtered = filter === "All"
    ? documents
    : documents.filter((d) => d.tags.includes(filter));
          ...
          <div className="bento-card rounded-lg overflow-hidden grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-8 lg:p-10 flex flex-col justify-center space-y-5">
              ...
              <h2 className="text-2xl md:text-3xl font-medium text-sand tracking-tight">
                DEEPVAC Company Overview
              </h2>
              <p className="text-sm text-gray leading-relaxed">
                A comprehensive introduction to DEEPVAC's thermal vacuum chamber platforms, engineering services, and technical capabilities. Includes product portfolio overview, service descriptions, and company background.
              </p>
