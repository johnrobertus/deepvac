...
const projectTypes = [
  "Standard Chamber Delivery",
  "Custom TVAC Development",
  ...
  <Layout>
    <PageShell>
      <PageHero
        ...
        title="References & Project Experience"
        description="Selected project categories and collaboration formats demonstrating DEEPVAC's engineering scope. Specific references and case studies will be published as they become available."
      />
      ...
      <Section>
        <SectionHeader
          ...
          description="DEEPVAC develops thermal vacuum systems for customers across these primary application domains."
          className="mb-14"
        />
      ...
      <Section className="bg-surface/30">
        <SectionHeader
          ...
          description="DEEPVAC supports projects across the full lifecycle of thermal vacuum systems."
          className="mb-10"
        />
      ...
      <Section>
        <SectionHeader
          ...
          description="Logos and references of selected partners and customers will be published as they become available."
          className="mb-10"
        />
          ...
          <div className="text-center space-y-3">
            <div className="flex items-center justify-center gap-6 flex-wrap">
              {Array.from({ length: 6 }).map((_, i) => (
                <div
                  key={i}
                  className="w-24 h-12 rounded-sm border border-gray/15 flex items-center justify-center"
                >
                  <span className="mono-label text-gray/25">Logo</span>
                </div>
              ))}
            </div>
            <p className="mono-label text-gray/30 pt-4">
      ...
      <Section className="bg-surface/30">
        <SectionHeader
          ...
          description="Detailed case studies will be published as project references become available for public communication."
          className="mb-10"
        />
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            ...
            <div key={i} className="bento-card rounded-lg overflow-hidden">
              ...
              <div className="p-6 space-y-3">
                ...
                <span className="flex items-center gap-1.5 text-xs text-gray/40 font-mono">
                  Full case study coming soon <ArrowRight className="w-3 h-3" />
                </span>
              </div>
            </div>
          ))}
      ...
      <Section>
        <div className="bento-card rounded-lg p-8 md:p-10 text-center space-y-4 max-w-2xl mx-auto">
          ...
          <p className="text-sm text-gray/40 italic max-w-lg mx-auto leading-relaxed">
            "Customer testimonials and project endorsements will be added as references become available for publication."
          </p>
      ...
      <CTABand
        ...
        description="Whether you're evaluating chamber platforms, planning a custom system, or exploring service and retrofit options — we're ready to discuss your requirements."
      >
        <Button asChild>
