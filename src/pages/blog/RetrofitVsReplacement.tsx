...
const RetrofitVsReplacement = () => {
  const { t } = useTranslation("blog");
  const p = "blog.articles.retrofitVsReplacement";
  ...
  return (
    ...
    >
      ...
      <Section title={t(`${p}.sections.replacementFavored.title`)}>
        <BulletList items={t(`${p}.sections.replacementFavored.points`, { returnObjects: true }) as string[]} />
      </Section>
      ...
      <Section title={t(`${p}.sections.commonMistakes.title`)}>
        <BulletList items={t(`${p}.sections.commonMistakes.points`, { returnObjects: true }) as string[]} />
      </Section>
...
export default RetrofitVsReplacement;
