...
const services = [
  {
    ...
    description: "Execution and support of thermal vacuum test campaigns for qualification, validation, and development programs requiring stable environmental control and repeatable workflows.",
    deliverables: ["Test campaign execution", "Data acquisition and reporting", "Qualification and acceptance testing", "Engineering support"],
    href: "/services/testing-services",
  },
  {
    icon: <Gauge className="w-6 h-6" />,
    title: "Control Systems Design",
    description: "Design of chamber control architectures, automation logic, user interfaces, instrumentation integration, and reliable operating concepts for TVAC environments.",
    deliverables: ["Control architecture design", "Automation and HMI development", "Instrumentation integration", "System commissioning"],
    href: "/services/control-systems-design",
  },
  {
    icon: <Settings className="w-6 h-6" />,
    title: "Mechanical Design",
    description: "Engineering of chamber assemblies, interfaces, fixturing, support structures, and customer-specific mechanical integration concepts.",
    deliverables: ["Chamber structural design", "Fixture engineering", "Interface specification", "Integration concepts"],
  ...
  },
  {
    ...
    deliverables: ["System assessment", "Upgrade engineering", "Control system modernisation", "Safety improvements"],
    href: "/services/retrofit-modernisation",
  },
  {
    icon: <Wrench className="w-6 h-6" />,
    title: "Maintenance & Repair",
    description: "Diagnostics, preventive servicing, repair, and technical support to reduce downtime and sustain chamber availability.",
    deliverables: ["Preventive maintenance", "Diagnostics and repair", "Spare parts support", "On-site service"],
  ...
  },
  {
    ...
    deliverables: ["Subsystem specification", "Interface engineering", "System integration", "Acceptance testing"],
