...
const products = [
  ...
  },
  {
    ...
    description:
      "Custom thermal vacuum systems for applications that fall outside the standard T and C series. These systems are developed for non-standard geometries, larger chamber volumes, extended temperature requirements, dedicated interfaces, or additional subsystems tailored to specific test and qualification tasks.",
    image: customImg,
