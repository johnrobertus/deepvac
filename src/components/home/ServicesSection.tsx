...
const services = [
  ...
  },
  {
    ...
    description: "Design of chamber control architectures, automation logic, user interfaces, and instrumentation integration for reliable and efficient system operation.",
    href: "/services/control-systems-design",
  },
  {
    icon: <Settings className="w-5 h-5" />,
    title: "Mechanical Design",
    description: "Engineering of chamber assemblies, interfaces, fixturing, support structures, and application-specific mechanical integration concepts.",
    href: "/services/mechanical-design",
  },
  {
    icon: <RefreshCw className="w-5 h-5" />,
    title: "Retrofit & Modernisation",
    description: "Technical upgrades for legacy TVAC systems to improve reliability, operability, safety, control precision, and lifecycle performance.",
    href: "/services/retrofit-modernisation",
  },
  {
    icon: <Wrench className="w-5 h-5" />,
    title: "Maintenance & Repair",
    description: "Diagnostics, servicing, preventive maintenance, and repair to support long-term chamber availability and reduced downtime.",
    href: "/services/maintenance-repair",
  },
  {
    icon: <Box className="w-5 h-5" />,
    title: "Subsystem Integration",
    description: "Integration of thermal, vacuum, instrumentation, and control subsystems into coherent test environments tailored to specific customer requirements.",
